...
export default function Sidebar() {
    ...
    return (
        ...
        <div
            className="d-flex flex-column flex-shrink-0 p-3 bg-white border-end vh-100 position-fixed"
            style={{
                width: '260px',
                zIndex: 1000
            }}
        >
            ...
            {/* LOGO + NAMA KAMPUS */}
            <div className="d-flex flex-column align-items-center mb-4 px-2 mt-2">
            ...
            <ul className="nav nav-pills flex-column mb-auto">
                ...
                {user?.role === 'admin' && (
                    <>
                        ...
                        <li className="nav-item mt-3 mb-2 px-3 text-muted small fw-bold text-uppercase">
                            Laporan
                        </li>

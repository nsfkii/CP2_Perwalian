    ...
    return (
        <div className="container-fluid">
            <div className="mb-4 d-flex align-items-center">
                <Link to="/admin/mahasiswa" className="btn btn-light me-3">
                    <FiArrowLeft /> Kembali
                </Link>
                <div>
                    <h4 className="fw-bold text-dark mb-0">Import Data Mahasiswa</h4>
                        ...
                        <Card.Body className="p-4">
                            <Form onSubmit={handleImport}>
                                <div className="text-center p-5 border rounded-3 mb-4" style={{ backgroundColor: '#f8fafc', borderStyle: 'dashed !important' }}>
                                    ...
                                    <p className="text-muted small mb-4">Pastikan format kolom sesuai:  <b>nim</b>, <b>nama</b>, <b>prodi</b>, <b>angkatan</b>, <b>kelas.</b> </p>
                                ...
                                {result.failed_rows > 0 && (
                                    <>
                                        <Alert variant="warning" className="small">
                                            Beberapa data gagal diimport (biasanya karena NIM duplikat). Berikut adalah detailnya:
                                        </Alert>
